...
describe Genomics::Interval do
  ...
  context "with Watson coordinates" do 
    ...
    before do
      @test = Genomics::Interval.new(CHROM, WATSON_START, WATSON_STOP)
    end
  ...
  context "with Crick coordinates" do
    ...
    before do
      @test = Genomics::Interval.new(CHROM, CRICK_START, CRICK_STOP)
    end
  ...
  context "with invalid start coordinate" do
    before do
      @test = Genomics::Interval.new(CHROM, -30, 4)
    end
  ...
  context "with invalid stop coordinate" do
    before do
      @test = Genomics::Interval.new(CHROM, 9, -1)
    end
  ...
  context "with zero start coordinate" do
    before do
      @test = Genomics::Interval.new(CHROM, 0, 10)
    end
